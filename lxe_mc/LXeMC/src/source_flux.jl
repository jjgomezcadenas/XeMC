"""
Source flux tables, source geometry loader, and flux generators.

Data structures for (E, u) probability distributions, source volume
loading from JSON, and single-source / compound flux generation for
Bi-214 and Tl-208.
"""

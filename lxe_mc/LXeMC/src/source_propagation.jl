...
Low-level building blocks for source flux generation: photon transport
inside a source volume, uniform position sampling, and direction
classification relative to the detector.
"""
